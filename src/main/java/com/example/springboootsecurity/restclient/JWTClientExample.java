package com.example.springboootsecurity.restclient;
...
public class JWTClientExample {
    ...
    static final String URL_LOGIN = "http://localhost:1807/login";
    static final String URL_EMPLOYEES = "http://localhost:1807/employees";
